...
function easy_breadcrumbs() {
  ...
  $delimiter = '<span class="delimeter">  /  </span>'; // разделить между "крошками"
...
function make_contents($content){
	...
	elseif($_mc_contain['contents']){
		$out = '<!--noindex--><div class="table-of-content"><div class="table-of-content__title"><b>СОДЕРЖАНИЕ:</b></div>';
		$out .= "\n<ul id='с_menu' class='contents'>\n". $contents ."</ul>\n</div><!--/noindex-->". $_content1;	
	}
